...
" markdown -------------------------------------------------------------------
hi markdownH1         guibg=NONE guifg=#9aad44 gui=bold
hi markdownH2         guibg=NONE guifg=#9aad44 gui=bold
hi markdownH3         guibg=NONE guifg=#9aad44 gui=bold
hi markdownH4         guibg=NONE guifg=#9aad44 gui=bold
hi markdownH5         guibg=NONE guifg=#9aad44 gui=bold
hi markdownH6         guibg=NONE guifg=#9aad44 gui=bold
...
hi markdownyellow     guibg=NONE guifg=#ad9355 gui=NONE

hi link markdownHeadingDelimiter  Comment
hi link markdownLinkText          PreProc
hi link markdownUrl               PreProc
hi link markdownCode              markdownyellow
hi link markdownCodeBlock         markdownyellow
